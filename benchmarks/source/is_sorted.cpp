...
static void
is_sorted_base(benchmark::State& state)
{
...
static void
is_sorted_vector_bool(benchmark::State& state)
{
...
static void
is_sorted_bitset(benchmark::State& state)
{
...
BENCHMARK(is_sorted_by_hand);
BENCHMARK(is_sorted_base);
