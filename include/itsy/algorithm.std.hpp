...
namespace std
{
	...
	find(
	  ::bitsy::bit_iterator<_It> __first, ::bitsy::bit_iterator<_It> __last, const _Type& __val)
	{
	...
	count(
	  ::bitsy::bit_iterator<_It> __first, ::bitsy::bit_iterator<_It> __last, const _Type& __value)
	{
	...
	constexpr _OutputIt
	copy(
	  ::bitsy::bit_iterator<_It> __first, ::bitsy::bit_iterator<_It> __last, _OutputIt __out_first)
	{
