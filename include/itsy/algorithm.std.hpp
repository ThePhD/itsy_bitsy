...
namespace std
{
	...
	{
		return ::bitsy::bit_find_first_of(
		     ::std::move(__first), ::std::move(__last), ::std::move(__search_first), ::std::move(__search_last));
	}
	...
	constexpr bool
	lexicographical_compare(::bitsy::bit_iterator<_InputIt0> __first0, ::bitsy::bit_iterator<_InputIt0> __last0,
	     ::bitsy::bit_iterator<_InputIt1> __first1, ::bitsy::bit_iterator<_InputIt1> __last1)
	{
	...
	is_sorted_until(::bitsy::bit_iterator<_ForwardIt> __first, ::bitsy::bit_iterator<_ForwardIt> __last)
	{
	...
	constexpr ::bitsy::bit_iterator<_ForwardIt>
	fill(::bitsy::bit_iterator<_ForwardIt> __first, ::bitsy::bit_iterator<_ForwardIt> __last, const _Type& __value)
	{
	...
	constexpr void
	sort(::bitsy::bit_iterator<_RandomAccessIt> __first, ::bitsy::bit_iterator<_RandomAccessIt> __last)
	{
		return ::bitsy::bit_sort(::std::move(__first), ::std::move(__last));
	}
} // namespace std
