...
TEMPLATE_TEST_CASE("bit_sequence reference_wrapper bulk resize test, unsigned",
     "[bit_sequence][reference_wrapper][bulk][resize][unsigned]", std::uint64_t, std::uint32_t, std::uint16_t,
