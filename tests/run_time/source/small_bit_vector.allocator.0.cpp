     ...
     std::ptrdiff_t, std::size_t)
{
	...
	sbv_allocator empty_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(empty_bit_vec_is_inline);
	...
	sbv_allocator il_empty_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(il_empty_bit_vec_is_inline);
	...
	sbv_allocator il_in_sbo_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(il_in_sbo_bit_vec_is_inline);
		...
		REQUIRE(il_in_sbo_bit_vec_alloc_allocations_alive == 1);
		...
		REQUIRE(il_in_sbo_bit_vec_alloc_allocations == 1);
	...
	sbv_allocator fl_empty_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(fl_empty_bit_vec_is_inline);
	...
	sbv_allocator fl_in_sbo_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(fl_in_sbo_bit_vec_is_inline);
		...
		REQUIRE(fl_in_sbo_bit_vec_alloc_allocations_alive == 1);
		...
		REQUIRE(fl_in_sbo_bit_vec_alloc_allocations == 1);
	...
	sbv_allocator fl_inplace_empty_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(fl_inplace_empty_bit_vec_is_inline);
	...
	sbv_allocator cv_in_sbo_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(cv_in_sbo_bit_vec_is_inline);
		...
		REQUIRE(cv_in_sbo_bit_vec_alloc_allocations_alive == 1);
		...
		REQUIRE(cv_in_sbo_bit_vec_alloc_allocations == 1);
	...
	sbv_allocator fl_inplace_in_sbo_bit_vec_allocator;
	{
		...
		REQUIRE_FALSE(fl_inplace_in_sbo_bit_vec_is_inline);
		...
		REQUIRE(fl_inplace_in_sbo_bit_vec_alloc_allocations_alive == 1);
		auto fl_inplace_in_sbo_bit_vec_alloc_constructions =
		     fl_inplace_in_sbo_bit_vec_alloc.constructions();
		REQUIRE(fl_inplace_in_sbo_bit_vec_alloc_constructions == 1);
		...
		REQUIRE(fl_inplace_in_sbo_bit_vec_alloc_allocations == 1);
