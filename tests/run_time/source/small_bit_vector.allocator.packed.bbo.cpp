...
TEMPLATE_TEST_CASE("packed_small_bit_vector<T, 512> allocator",
     "[packed_small_bit_vector<T, 512>][allocator]", std::uint64_t, std::uint32_t, std::uint16_t,
     std::uint8_t, std::byte, std::int64_t, std::int32_t, std::int16_t, std::int8_t, char32_t,
     char16_t, char, unsigned char, signed char, std::ptrdiff_t, std::size_t)
{
	...
	using tracking_sbv      = bitsy::packed_small_bit_vector<TestType, 512, sbv_allocator_ref>;
