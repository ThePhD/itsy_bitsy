...
TEMPLATE_TEST_CASE("packed_small_bit_vector allocator", "[packed_small_bit_vector<T>][allocator]",
     ...
     std::ptrdiff_t, std::size_t)
{
	...
	using tracking_sbv      = bitsy::packed_small_bit_vector<TestType, 2, sbv_allocator_ref>;
